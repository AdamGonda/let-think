    ...
    <div className="flex h-screen bg-white dark:bg-[#16171d]">
      ...
      <main className="flex flex-1 flex-col min-w-0">
        <div className="flex flex-1 min-h-0 flex-col">
          {isLoading && (
            <div className="flex items-center justify-center gap-4 py-12 shrink-0">
              <svg
                className="animate-spin h-10 w-10 text-violet-600 dark:text-violet-400"
              ...
              <span className="text-xl font-medium text-violet-600 dark:text-violet-400 animate-pulse">
                Thinking...
              </span>
            </div>
          )}
