...
export function DataPolicyPage() {
  return (
    <LegalDocLayout title="Data policy" lastUpdated="April 19, 2026">
      <p>
        This page describes how Think (“we”, “us”) handles information when you
      ...
      <p>
        Content you create in Think—such as projects, sessions, notes, and
        messages—may be stored to provide the product and to sync it across your
        devices.
      </p>
      <h2>How we use data</h2>
      <p>
        We use account and usage information to operate Think, improve
