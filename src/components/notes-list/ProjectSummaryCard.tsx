...
export function ProjectSummaryCard({
  ...
  return (
    ...
    >
      ...
      >
        <span className="min-w-0 text-base font-semibold leading-[1.25] text-foreground line-clamp-2">
          {title}
        </span>
        <p className="mt-auto text-xs text-muted-foreground/90 pt-1 tabular-nums">
          {fileCountLabel}
        </p>
      </button>
    </div>
